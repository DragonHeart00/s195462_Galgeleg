...
import com.example.s195462galgeleg.logic.LogikF;
...
public class GetStartF extends AppCompatActivity implements View.OnClickListener {


    LogikF logikF = new LogikF();
       ...
       */
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                show_first_char.setText("Ordet starter med bogstav "+logikF.getOrdet().charAt(0));
            }
        });
        ...
        // guss word ******
        guessTekst.setText(logikF.getSynligtOrd());
    ...
    private void myOnClick(Button letterButton) {
        ...
        switch (logikF.getAntalForkerteBogstaver()){
        ...
        if (logikF.erSpilletVundet()) {
            //Send user to WinnerActivity


            if (logikF.getAntalForkerteBogstaver() == 0){
                score= 400;
                score+=score * 2 + logikF.getOrdet().length();

            }else {
                score+=200;
                score+= logikF.getOrdet().length() * logikF.getAntalForkerteBogstaver();
            ...
            intent.putExtra("AntalForkerteBogstaver",logikF.getAntalForkerteBogstaver()+"");
            ...
            Toast.makeText(getApplicationContext(),logikF.getOrdet() + "\n score:" +score,Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(this, LoserActivity.class);
            intent.putExtra("data",logikF.getOrdet());
            intent.putExtra("yScore",score +"");
            startActivity(intent);
            finish();
